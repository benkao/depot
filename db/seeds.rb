...
Product.create!(title: 'Seven Mobile Apps in Seven Weeks',
  description:
    %{<p>
      ...
      Answer the question ?an we build this for ALL the devices???with a
      resounding YES. This book will help you get there with a real-world
      introduction to seven platforms, whether you?e new to mobile or an
      experienced developer needing to expand your options. Plus, you?l find
...
Product.create!(title: 'Ruby Performance Optimization',
  description:
    %{<p>
      ...
      You don? have to accept slow Ruby or Rails performance. In this
      comprehensive guide to Ruby optimization, you?l learn how to write
      faster Ruby code?ut that? just the beginning. See exactly what makes
      ...
      performance testing, garbage collection, and tuning. You?l find that
      all those ?ard??things aren? so difficult after all, and your code
